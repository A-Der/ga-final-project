...
# Key Learnings
This was a great experience using relational databases and how powerful they can be. Django was a bit daunting at first but after feeling the value that the structure brings, I've become a fan. Using Python for the first time too, I was able to see how learning one language crosses over into another. As in, it was not like learning programming for the first time again, but just understanding the same concepts and logic, just written differently. I look forward to using Django and Python again in a future project.